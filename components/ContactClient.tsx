    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 lg:pt-48 lg:pb-32 bg-[#0a1128] text-white relative overflow-hidden">
        ...
        <div className="w-[90%] mx-auto relative z-10 text-center">
          ...
          >
            <span className="text-sm font-bold text-[#07a447] tracking-wider uppercase">24/7 Expert Support</span>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              Contact <span className="text-[#07a447] relative">
                Us
            ...
            <motion.p
              ...
              className="text-lg lg:text-xl text-gray-400 mb-12 leading-relaxed font-medium"
            >
